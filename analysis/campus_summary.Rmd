...
```{r load, message = FALSE, warning = FALSE, include = F}
library(tidyverse)
...
This analysis examines electricity use on Dickinson's campus as a whole in fiscal year 2025, to provide context for the more specific analyses that follow. Please explore the category-specific summaries for more detailed results and recommendations. 

```{r graph meter, warning = F, fig.width = 6, fig.height = 4, include = F}
