...
```{r footprint, fig.align = 'center', out.width = "30%", include = F}
knitr::include_graphics("assets/carbon_footprint.png", error = FALSE)
```

```{r costs, fig.align = 'center', out.width = "50%", include = F}
knitr::include_graphics("assets/electric-costs.png", error = FALSE)
```
...
We wish to extend a special thanks to Mike Kiner, Director of Trades, for sharing his time and expertise for the duration of this project. We also thank all attendees at our final presentation in April 2026, who offered valuable insights that informed our interpretation. That said, any and all mistakes are our own. 
